...
- 💡 My main languages is [**Java**](https://www.oracle.com/br/java/) with [**Spring boot**](https://spring.io/) and [**TS**](https://www.typescriptlang.org/docs/) , but i'm open to discovering new worlds.
